...
{
    internal unsafe struct Query<T1> : IQuery where T1 : unmanaged
    {
        private readonly int _type1;
        private readonly QueryFunc<T1> _func;

        public Query(QueryFunc<T1> func)
        {
        ...
        public unsafe void Func(EntityGroup group, int chunkIndex, int* indices)
        {
            ...
            for (int k = 0; k < count; k++)
            {
                try
                {
                    _func.Invoke(ref Unsafe.AsRef<T1>(list));
                }
                catch (Exception e)
                {
#if DEBUG
    ...
    internal unsafe struct Query<T1, T2> : IQuery
        where T1 : unmanaged
        where T2 : unmanaged
    {
        private readonly int _type1;
        private readonly int _type2;
        private readonly QueryFunc<T1, T2> _func;

        public Query(QueryFunc<T1, T2> func)
        {
            _type1 = TypeCache<T1>.Type;
    ...
    internal unsafe struct Query<T1, T2, T3> : IQuery
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
    {
        ...
        private readonly QueryFunc<T1, T2, T3> _func;

        public Query(QueryFunc<T1, T2, T3> func)
        {
            _type1 = TypeCache<T1>.Type;
            _type2 = TypeCache<T2>.Type;
    ...
    internal unsafe struct Query<T1, T2, T3, T4> : IQuery
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
        where T4 : unmanaged
    {
        ...
        private readonly QueryFunc<T1, T2, T3, T4> _func;

        public Query(QueryFunc<T1, T2, T3, T4> func)
        {
            _type1 = TypeCache<T1>.Type;
            _type2 = TypeCache<T2>.Type;
            _type3 = TypeCache<T3>.Type;
    ...
    internal unsafe struct Query<T1, T2, T3, T4, T5> : IQuery
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
        where T4 : unmanaged
        where T5 : unmanaged
    {
        ...
        private readonly QueryFunc<T1, T2, T3, T4, T5> _func;

        public Query(QueryFunc<T1, T2, T3, T4, T5> func)
        {
            _type1 = TypeCache<T1>.Type;
            _type2 = TypeCache<T2>.Type;
            _type3 = TypeCache<T3>.Type;
    ...
    internal unsafe struct Query<T1, T2, T3, T4, T5, T6> : IQuery
        where T1 : unmanaged
        where T2 : unmanaged
        where T3 : unmanaged
        where T4 : unmanaged
        ...
        where T6 : unmanaged
    {
        ...
        private readonly QueryFunc<T1, T2, T3, T4, T5, T6> _func;

        public Query(QueryFunc<T1, T2, T3, T4, T5, T6> func)
        {
            _type1 = TypeCache<T1>.Type;
            _type2 = TypeCache<T2>.Type;
            _type3 = TypeCache<T3>.Type;
        ...
        public unsafe void AddRequiredArchetypes(ref EntityArchetype archetype, ref int maxDepth)
        {
            ...
            Entities.AddtoFilter(ref archetype, ref maxDepth, _type4);
            Entities.AddtoFilter(ref archetype, ref maxDepth, _type5);
            Entities.AddtoFilter(ref archetype, ref maxDepth, _type6);
        }
